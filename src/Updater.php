...
final class Updater {
	 ...
	 */
	public const REPOSITORY_URL = 'https://github.com/BenoitBonavia/extender-advanced-shipment-tracking/';
	 ...
	 */
	public const TOKEN_CONSTANT = 'EAST_GITHUB_TOKEN';
	 ...
	 *
	 * Volontairement appelé avant le contrôle des prérequis : même si
	 * WooCommerce ou Advanced Shipment Tracking manquaient, le site doit pouvoir
	 * recevoir un correctif de ce plugin.
	 *
	...
	public static function register() {
		...
		$library = EAST_PATH . 'lib/plugin-update-checker/plugin-update-checker.php';
	...
	public static function get_slug(): string {
		$directory = dirname( EAST_BASENAME );

		if ( '' === $directory || '.' === $directory ) {
			return 'extender-advanced-shipment-tracking';
		}
